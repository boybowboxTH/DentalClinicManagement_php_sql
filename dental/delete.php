...
<center><h2>ลบข้อมูลคนไข้</h2></center>
<?php
...
// Display a message
echo '<center><h3>ลบเรียบร้อย</h3></center>';
} else { // If the query failed to run
echo '<p class="error">ยังไม่ได้ลบ<br>เกิดข้อผิดพลาด</p>'; // Display error message
...
echo "<center><h3>คุณต้องการลบข้อมูลถาวรหรือไม่ $row[0]?</h3><center>";
