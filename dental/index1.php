...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope"></i> <a href="mailto:visakra-clinic@gmail.com">visakra-clinic@gmail.com</a>
        <i class="bi bi-phone"></i> +66 8211232655
      </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><img src="download.png" width="40" height="40" class="logo"><a href="index.html">ทันตแพทย์วิสาขา</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="dentistuser.php">รายชื่อหมอ</a></li>
          <li><a class="nav-link scrollto" href="clinicinfo.php">รายละเอียดสาขา</a></li>
          <li><a class="nav-link scrollto" href="dentalcodesviewuser.php">รายการทำฟัน</a></li>
          ...
          <li><a href="index.html" class="logout" style="margin: 0px auto;">ล็อกเอ้าท์</a></li>
		  <li><a class="nav-link scrollto" href="signup.php">ลงทะเบียน</a></li>
        </ul>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>ยินดีต้อนรับ <?php echo htmlspecialchars($name, ENT_QUOTES, 'UTF-8'); ?>
      <h2>คลินิกทันตแพทย์วิสาขา ได้รับการรับรองอย่างถูกกฎหมาย</h2>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              <h3>ทำไมต้องคลินิกทัตเเพทย์วิสาขา</h3>
              <p>
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>ใบรับรอง</h4>
                    <p>คลินิกทันตแพทย์วิสาขาของเราได้รับใบรับรองในด้าน ถอนฟัน ทำฟันเทียมเเเละในด้านต่างๆในระดับดีเยี่ยม</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>ความทันสมัย</h4>
                    <p>คลินิกทันตแพทย์วิสาขาของเรามีความทันสมัยตอบโจทย์ทุกสภาพฟันเเละมีเครื่องมือครบ</p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
              ...
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <p>
                    ...
                    คลินิกทันตแพทย์วิสาขาของเราพร้อมบริการทุกท่าน ทุกท่านสามารถเชื่อใจทางคลินิกของเราได้ พวกเรามีความเป็นมืออาชีพเเละได้รับรางวัลมากมาย
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>ที่ตั้ง</h2>
          <p>คลินิกทันตแพทย์วิสาขา ของเราตั้งอยู่ที่สามพราน เเละเราตั้งใจจะขยายทั่วประเทศ</p>
        </div>
      </div>
  ...
  <!-- ======= Footer ======= -->
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>คลินิกทันตแพทย์วิสาขา</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
